...
A camada de autenticação e autorização foi implementada para que **os mesmos endpoints protegidos** possam ser acedidos por **mecanismos alternativos de autenticação** (OR), alinhados com os laboratórios:
